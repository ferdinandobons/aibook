...
| `SNIP-ATT-003` | `snip_att_003_causal_mask.py` | causal mask e coefficienti futuri nulli |

`SNIP-ATT-004`, relativo alla multi-head attention, è stato rimosso dopo la review didattica. Il meccanismo appartiene al capitolo successivo.
