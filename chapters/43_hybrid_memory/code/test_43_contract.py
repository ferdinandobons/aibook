...
from snip_43_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'local_size': 2, 'long_term_size': 1, 'read': 'recent-b', 'invariant': 'local and long-term memory have separate lifetimes'})
