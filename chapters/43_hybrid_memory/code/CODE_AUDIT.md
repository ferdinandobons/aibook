...
- API: funzioni Python standard del modulo snip_43_contract
- comando snippet: python snip_43_contract.py
- comando test: python -m unittest -v test_43_contract.py
- snippet: eseguito
- test: 4 superati
