...
- API: funzioni Python standard del modulo snip_61_contract
- comando snippet: python snip_61_contract.py
- comando test: python -m unittest -v test_61_contract.py
- snippet: eseguito
- test: 4 superati
