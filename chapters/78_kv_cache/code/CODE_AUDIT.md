...
- API: funzioni Python standard del modulo snip_78_contract
- comando snippet: python snip_78_contract.py
- comando test: python -m unittest -v test_78_contract.py
- snippet: eseguito
- test: 4 superati
