...
from snip_78_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'shared_prefix': 2, 'request_lengths': {'r1': 3, 'r2': 3}, 'invariant': 'cache reuse preserves token position and request ownership'})
