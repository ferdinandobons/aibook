...
from snip_92_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'digest_prefix': '9f84b58f871a', 'tamper_detected': True, 'invariant': 'provenance detects a changed record but does not certify its truth'})
