...
- API: funzioni Python standard del modulo snip_92_contract
- comando snippet: python snip_92_contract.py
- comando test: python -m unittest -v test_92_contract.py
- snippet: eseguito
- test: 4 superati
