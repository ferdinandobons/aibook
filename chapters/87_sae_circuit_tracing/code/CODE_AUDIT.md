...
- API: funzioni Python standard del modulo snip_87_contract
- comando snippet: python snip_87_contract.py
- comando test: python -m unittest -v test_87_contract.py
- snippet: eseguito
- test: 4 superati
