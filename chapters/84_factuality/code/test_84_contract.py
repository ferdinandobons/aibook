...
from snip_84_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'accuracy': 0.75, 'confident_errors': 1, 'invariant': 'confidence is evaluated against factual correctness, not substituted for it'})
