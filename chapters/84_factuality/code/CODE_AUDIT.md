...
- API: funzioni Python standard del modulo snip_84_contract
- comando snippet: python snip_84_contract.py
- comando test: python -m unittest -v test_84_contract.py
- snippet: eseguito
- test: 4 superati
