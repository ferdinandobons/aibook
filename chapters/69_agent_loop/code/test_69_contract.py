...
from snip_69_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'events': ['observe', 'plan', 'tool', 'verify'], 'valid': True, 'invariant': 'an agent loop records observation, action and verification'})
