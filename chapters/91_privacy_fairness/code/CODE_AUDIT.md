...
- API: funzioni Python standard del modulo snip_91_contract
- comando snippet: python snip_91_contract.py
- comando test: python -m unittest -v test_91_contract.py
- snippet: eseguito
- test: 4 superati
