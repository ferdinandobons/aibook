...
from snip_91_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'accuracy_by_group': {'A': 0.75, 'B': 0.5}, 'gap': 0.25, 'invariant': 'aggregate utility does not hide group-specific outcomes'})
