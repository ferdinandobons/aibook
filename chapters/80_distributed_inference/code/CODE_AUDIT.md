...
- API: funzioni Python standard del modulo snip_80_contract
- comando snippet: python snip_80_contract.py
- comando test: python -m unittest -v test_80_contract.py
- snippet: eseguito
- test: 4 superati
