...
- API: funzioni Python standard del modulo snip_36_contract
- comando snippet: python snip_36_contract.py
- comando test: python -m unittest -v test_36_contract.py
- snippet: eseguito
- test: 4 superati
