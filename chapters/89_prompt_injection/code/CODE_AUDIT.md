...
- API: funzioni Python standard del modulo snip_89_contract
- comando snippet: python snip_89_contract.py
- comando test: python -m unittest -v test_89_contract.py
- snippet: eseguito
- test: 4 superati
