...
from snip_56_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'scores': [0.45, 0.44999999999999996], 'selected_patch': 0, 'invariant': 'visual grounding links a text query to explicit image features'})
