...
- API: funzioni Python standard del modulo snip_56_contract
- comando snippet: python snip_56_contract.py
- comando test: python -m unittest -v test_56_contract.py
- snippet: eseguito
- test: 4 superati
