...
- API: funzioni Python standard del modulo snip_40_contract
- comando snippet: python snip_40_contract.py
- comando test: python -m unittest -v test_40_contract.py
- snippet: eseguito
- test: 4 superati
