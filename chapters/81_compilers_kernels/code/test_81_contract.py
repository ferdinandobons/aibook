...
from snip_81_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'original_ops': 3, 'fused_ops': 2, 'invariant': 'compiler optimization preserves the declared operator result'})
