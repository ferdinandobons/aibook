...
- API: funzioni Python standard del modulo snip_81_contract
- comando snippet: python snip_81_contract.py
- comando test: python -m unittest -v test_81_contract.py
- snippet: eseguito
- test: 4 superati
