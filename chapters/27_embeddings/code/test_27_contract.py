...
from snip_27_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'static': [1.0, 0.0], 'contextual': [1.2, 0.8], 'invariant': 'an embedding lookup is distinct from later contextualization'})
