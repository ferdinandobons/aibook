...
- API: funzioni Python standard del modulo snip_27_contract
- comando snippet: python snip_27_contract.py
- comando test: python -m unittest -v test_27_contract.py
- snippet: eseguito
- test: 4 superati
