...
- API: funzioni Python standard del modulo snip_35_contract
- comando snippet: python snip_35_contract.py
- comando test: python -m unittest -v test_35_contract.py
- snippet: eseguito
- test: 4 superati
