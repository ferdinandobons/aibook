...
- API: funzioni Python standard del modulo snip_47_contract
- comando snippet: python snip_47_contract.py
- comando test: python -m unittest -v test_47_contract.py
- snippet: eseguito
- test: 4 superati
