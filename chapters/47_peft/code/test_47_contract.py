...
from snip_47_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'delta': [0.2, -0.1], 'adapted': [1.2, 1.9], 'invariant': 'the low-rank update is separated from frozen base weights'})
