...
- API: funzioni Python standard del modulo snip_15_contract
- comando snippet: python snip_15_contract.py
- comando test: python -m unittest -v test_15_contract.py
- snippet: eseguito
- test: 4 superati
