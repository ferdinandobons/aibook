...
- API: funzioni Python standard del modulo snip_83_contract
- comando snippet: python snip_83_contract.py
- comando test: python -m unittest -v test_83_contract.py
- snippet: eseguito
- test: 4 superati
