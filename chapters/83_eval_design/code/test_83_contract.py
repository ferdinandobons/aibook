...
from snip_83_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'accuracy': 0.75, 'failures': [1], 'invariant': 'a metric is reported with its decision target and failure cases'})
