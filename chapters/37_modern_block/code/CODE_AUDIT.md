...
- API: funzioni Python standard del modulo snip_37_contract
- comando snippet: python snip_37_contract.py
- comando test: python -m unittest -v test_37_contract.py
- snippet: eseguito
- test: 4 superati
