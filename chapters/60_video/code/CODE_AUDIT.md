...
- API: funzioni Python standard del modulo snip_60_contract
- comando snippet: python snip_60_contract.py
- comando test: python -m unittest -v test_60_contract.py
- snippet: eseguito
- test: 4 superati
