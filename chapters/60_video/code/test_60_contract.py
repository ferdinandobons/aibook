...
from snip_60_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'frame_count': 3, 'temporal_order': ['f0', 'f1', 'f2'], 'invariant': 'video generation keeps an explicit temporal index'})
