...
- API: funzioni Python standard del modulo snip_82_contract
- comando snippet: python snip_82_contract.py
- comando test: python -m unittest -v test_82_contract.py
- snippet: eseguito
- test: 4 superati
