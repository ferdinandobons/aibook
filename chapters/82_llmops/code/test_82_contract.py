...
from snip_82_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'model': 'v1', 'cost': 0.12, 'invariant': 'an operational metric records model version and measurement boundary'})
