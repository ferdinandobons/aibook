...
- comando snippet: `python snip_94_contract.py`
- comando test: `python -m unittest -v test_94_contract.py`
...
- laboratorio esteso: `python foundations_lab.py`
- test laboratorio: `python -m unittest -v test_foundations_lab.py` (4 superati)
- output laboratorio: `outputs/FOUNDATIONS-LAB.txt`
