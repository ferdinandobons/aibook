...
from snip_94_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'configuration_digest': '47f01c1610dd', 'configuration': {'seed': 7, 'split': 'fixed', 'dtype': 'float32'}, 'invariant': 'a local run is reproducible only with its declared setup'})
