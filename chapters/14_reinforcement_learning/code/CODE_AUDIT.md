...
- API: funzioni Python standard del modulo snip_14_contract
- comando snippet: python snip_14_contract.py
- comando test: python -m unittest -v test_14_contract.py
- snippet: eseguito
- test: 4 superati
