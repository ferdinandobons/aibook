...
from snip_73_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'distillation_error': 0.08, 'kept_weights': 1, 'invariant': 'compression quality and structural pruning are measured separately'})
