...
- API: funzioni Python standard del modulo snip_73_contract
- comando snippet: python snip_73_contract.py
- comando test: python -m unittest -v test_73_contract.py
- snippet: eseguito
- test: 4 superati
