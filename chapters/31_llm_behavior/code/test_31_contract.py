...
from snip_31_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'demonstrations': 2, 'probabilities': [0.665241, 0.244728, 0.090031], 'chosen': 0, 'invariant': 'decoding selects from a distribution and does not certify truth'})
