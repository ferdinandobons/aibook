...
- API: funzioni Python standard del modulo snip_51_contract
- comando snippet: python snip_51_contract.py
- comando test: python -m unittest -v test_51_contract.py
- snippet: eseguito
- test: 4 superati
