...
- API: funzioni Python standard del modulo snip_32_contract
- comando snippet: python snip_32_contract.py
- comando test: python -m unittest -v test_32_contract.py
- snippet: eseguito
- test: 4 superati
