...
from snip_32_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'manifest': {'ids': ['a', 'b'], 'sources': ['crm', 'mail']}, 'invariant': 'data transformations retain provenance and a stable record identity'})
