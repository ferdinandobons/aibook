...
- API: funzioni Python standard del modulo snip_45_contract
- comando snippet: python snip_45_contract.py
- comando test: python -m unittest -v test_45_contract.py
- snippet: eseguito
- test: 4 superati
