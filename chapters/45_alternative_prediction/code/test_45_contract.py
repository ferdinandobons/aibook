...
from snip_45_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'bytes': [65, 73], 'groups': [[65, 73]], 'invariant': 'byte grouping is explicit before any higher-level prediction'})
