...
- API: funzioni Python standard del modulo snip_49_contract
- comando snippet: python snip_49_contract.py
- comando test: python -m unittest -v test_49_contract.py
- snippet: eseguito
- test: 4 superati
