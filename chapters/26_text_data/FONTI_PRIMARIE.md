# Fonti primarie e autorevoli. Capitolo 26

- Data di consultazione: 4 agosto 2026
- Routing semantico: capitolo 26 -> tema `text_data`.
...
- Titolo o riferimento: Unicode Consortium, The Unicode Standard.
- Autori o organizzazione: Unicode Consortium.
...
- URL o identificatore: https://www.unicode.org/versions/latest/
- Data di consultazione: 4 agosto 2026.
...
- Sezioni rilevanti: Abstract / pagina iniziale; Unicode® 17.0.0; New Data Files for Unicode 17.0; Unicode Standard Annexes.
...
- Affermazioni sostenibili: Il testo è una sequenza di code point codificata in byte. Token per carattere variano tra lingue e formati.
...
- Titolo o riferimento: Sennrich, Haddow and Birch, Neural Machine Translation of Rare Words with Subword Units.
- Autori o organizzazione: Sennrich.
- Tipo: paper o report tecnico.
- Data: data della revisione consultata.
- Versione, revisione o commit: revisione o versione disponibile all'URL consultato il 4 agosto 2026.
- URL o identificatore: https://arxiv.org/abs/1508.07909
- Data di consultazione: 4 agosto 2026.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: BPE, WordPiece e Unigram costruiscono vocabolari subword con algoritmi differenti.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: BOS, EOS, padding, separatori e marker di ruolo hanno significati operativi.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Più documenti possono condividere una sequenza.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
