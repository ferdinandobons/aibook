...
- API: funzioni Python standard del modulo snip_26_contract
- comando snippet: python snip_26_contract.py
- comando test: python -m unittest -v test_26_contract.py
- snippet: eseguito
- test: 4 superati
