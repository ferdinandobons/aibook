...
- API: funzioni Python standard del modulo snip_63_contract
- comando snippet: python snip_63_contract.py
- comando test: python -m unittest -v test_63_contract.py
- snippet: eseguito
- test: 4 superati
