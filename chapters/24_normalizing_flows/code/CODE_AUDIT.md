...
- API: funzioni Python standard del modulo snip_24_contract
- comando snippet: python snip_24_contract.py
- comando test: python -m unittest -v test_24_contract.py
- snippet: eseguito
- test: 4 superati
