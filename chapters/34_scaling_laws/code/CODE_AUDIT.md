...
- API: funzioni Python standard del modulo snip_34_contract
- comando snippet: python snip_34_contract.py
- comando test: python -m unittest -v test_34_contract.py
- snippet: eseguito
- test: 4 superati
