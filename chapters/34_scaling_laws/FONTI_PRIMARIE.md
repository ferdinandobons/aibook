# Fonti primarie e autorevoli. Capitolo 34

- Data di consultazione: 3 agosto 2026
- Routing semantico: capitolo 34 -> tema `scaling`.
...
- Titolo o riferimento: Kaplan et al., Scaling Laws for Neural Language Models.
- Autori o organizzazione: Kaplan et al..
...
- URL o identificatore: https://arxiv.org/abs/2001.08361
- Data di consultazione: 3 agosto 2026.
...
- Sezioni rilevanti: Abstract / pagina iniziale; Scaling Laws for Neural Language Models; 1.2 Summary of Scaling Laws; 2.1 Parameter and Compute Scaling of Transformers.
...
- Affermazioni sostenibili: Una power law approssima loss rispetto a parametri, dati o compute in un intervallo misurato. Una scelta compute-optimal per il training può non minimizzare costo e latenza del servizio.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: A budget fissato, modello e token competono.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Configurazioni con compute simile rendono osservabile la loss minima per budget.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Residui, intervalli e ipotesi su loss irriducibile limitano la previsione fuori scala.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
