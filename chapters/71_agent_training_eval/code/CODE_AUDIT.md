...
- API: funzioni Python standard del modulo snip_71_contract
- comando snippet: python snip_71_contract.py
- comando test: python -m unittest -v test_71_contract.py
- snippet: eseguito
- test: 4 superati
