...
from snip_71_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'task_success': 2, 'safe_success': 1, 'invariant': 'task completion and policy compliance are separate metrics'})
