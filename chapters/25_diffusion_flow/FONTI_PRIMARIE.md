# Fonti primarie e autorevoli. Capitolo 25

- Data di consultazione: 3 agosto 2026
- Routing semantico: capitolo 25 -> tema `diffusion`.
...
- Affermazioni sostenibili: La diffusione forward aggiunge rumore secondo uno schedule. Flow matching apprende un campo vettoriale lungo percorsi scelti tra distribuzioni.
...
- Titolo o riferimento: Song et al., Score-Based Generative Modeling through Stochastic Differential Equations.
- Autori o organizzazione: Song et al..
- Tipo: paper o report tecnico.
- Data: data della revisione consultata.
- Versione, revisione o commit: revisione o versione disponibile all'URL consultato il 3 agosto 2026.
- URL o identificatore: https://arxiv.org/abs/2011.13456
- Data di consultazione: 3 agosto 2026.
- Verifica d'accesso: opened-context; pagina originale aperta; titolo, testo e intestazioni estratti; nessun risultato numerico trasferito.
- Sezioni rilevanti: Abstract / pagina iniziale; Score-Based Generative Modeling through Stochastic Differential Equations; 2.1 Denoising score matching with Langevin dynamics (SMLD); 2.2 Denoising diffusion probabilistic models (DDPM).
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Lo score è il gradiente del log-density rispetto ai dati perturbati.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.

## SRC-25-003

- Titolo o riferimento: Lipman et al., Flow Matching for Generative Modeling.
- Autori o organizzazione: Lipman et al..
- Tipo: paper o report tecnico.
- Data: data della revisione consultata.
- Versione, revisione o commit: revisione o versione disponibile all'URL consultato il 3 agosto 2026.
- URL o identificatore: https://arxiv.org/abs/2210.02747
- Data di consultazione: 3 agosto 2026.
- Verifica d'accesso: opened-context; pagina originale aperta; titolo, testo e intestazioni estratti; nessun risultato numerico trasferito.
- Sezioni rilevanti: Abstract / pagina iniziale; Flow Matching for Generative Modeling; 3 Flow Matching; 3.2 Conditional Flow Matching.
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Target differenti sono trasformazioni della stessa relazione sotto uno schedule, ma cambiano scala e weighting del training.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: DDPM, DDIM e solver ODE/SDE usano discretizzazioni differenti.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
