...
- API: funzioni Python standard del modulo snip_25_contract
- comando snippet: python snip_25_contract.py
- comando test: python -m unittest -v test_25_contract.py
- snippet: eseguito
- test: 4 superati
