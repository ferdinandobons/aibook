...
- API: funzioni Python standard del modulo snip_44_contract
- comando snippet: python snip_44_contract.py
- comando test: python -m unittest -v test_44_contract.py
- snippet: eseguito
- test: 4 superati
