...
from snip_44_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'selected_experts': [1, 2], 'loads': [0, 1, 1, 0], 'invariant': 'top-k routing and capacity accounting are explicit'})
