...
- API: funzioni Python standard del modulo snip_70_contract
- comando snippet: python snip_70_contract.py
- comando test: python -m unittest -v test_70_contract.py
- snippet: eseguito
- test: 4 superati
