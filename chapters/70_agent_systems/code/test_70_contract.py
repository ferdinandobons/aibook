...
from snip_70_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'roles': ['planner', 'executor', 'critic'], 'message_count': 3, 'invariant': 'multi-agent coordination exposes role and message boundaries'})
