...
- API: funzioni Python standard del modulo snip_90_contract
- comando snippet: python snip_90_contract.py
- comando test: python -m unittest -v test_90_contract.py
- snippet: eseguito
- test: 4 superati
