...
- API: funzioni Python standard del modulo snip_20_contract
- comando snippet: python snip_20_contract.py
- comando test: python -m unittest -v test_20_contract.py
- snippet: eseguito
- test: 4 superati
