...
- API: funzioni Python standard del modulo snip_23_contract
- comando snippet: python snip_23_contract.py
- comando test: python -m unittest -v test_23_contract.py
- snippet: eseguito
- test: 4 superati
