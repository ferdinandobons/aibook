...
from snip_23_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'discriminator_gap': 0.6, 'invariant': 'generator and discriminator signals are not the same loss'})
