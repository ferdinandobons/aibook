...
- API: funzioni Python standard del modulo snip_17_contract
- comando snippet: python snip_17_contract.py
- comando test: python -m unittest -v test_17_contract.py
- snippet: eseguito
- test: 4 superati
