...
from snip_88_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'attack_success_rate': 0.5, 'failures': ['perturbed'], 'invariant': 'robustness is defined relative to an explicit threat model'})
