...
- API: funzioni Python standard del modulo snip_88_contract
- comando snippet: python snip_88_contract.py
- comando test: python -m unittest -v test_88_contract.py
- snippet: eseguito
- test: 4 superati
