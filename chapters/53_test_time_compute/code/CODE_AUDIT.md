...
- API: funzioni Python standard del modulo snip_53_contract
- comando snippet: python snip_53_contract.py
- comando test: python -m unittest -v test_53_contract.py
- snippet: eseguito
- test: 4 superati
