...
from snip_53_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'samples': 3, 'best_score': 0.6, 'invariant': 'test-time compute changes the selection budget, not the base model weights'})
