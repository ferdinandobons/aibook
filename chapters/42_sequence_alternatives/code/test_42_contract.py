...
from snip_42_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'outputs': [0.4, 0.32, -0.144], 'invariant': 'the state update is explicit before each emitted value'})
