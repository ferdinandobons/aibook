...
- API: funzioni Python standard del modulo snip_42_contract
- comando snippet: python snip_42_contract.py
- comando test: python -m unittest -v test_42_contract.py
- snippet: eseguito
- test: 4 superati
