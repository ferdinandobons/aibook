...
- API: funzioni Python standard del modulo snip_95_contract
- comando snippet: python snip_95_contract.py
- comando test: python -m unittest -v test_95_contract.py
- snippet: eseguito
- test: 4 superati
