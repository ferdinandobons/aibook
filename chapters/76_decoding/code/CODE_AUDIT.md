...
- API: funzioni Python standard del modulo snip_76_contract
- comando snippet: python snip_76_contract.py
- comando test: python -m unittest -v test_76_contract.py
- snippet: eseguito
- test: 4 superati
