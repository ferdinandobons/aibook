...
from snip_59_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'frames': [[0.0, 0.5], [-0.5, 0.0]], 'sample_count': 4, 'invariant': 'audio framing preserves sample order and declared frame size'})
