...
- API: funzioni Python standard del modulo snip_59_contract
- comando snippet: python snip_59_contract.py
- comando test: python -m unittest -v test_59_contract.py
- snippet: eseguito
- test: 4 superati
