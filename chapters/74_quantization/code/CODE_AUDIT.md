...
- API: funzioni Python standard del modulo snip_74_contract
- comando snippet: python snip_74_contract.py
- comando test: python -m unittest -v test_74_contract.py
- snippet: eseguito
- test: 4 superati
