...
from snip_74_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'quantized': [-2, 0, 2], 'restored': [-0.5, 0.0, 0.5], 'max_error': 0.0, 'invariant': 'scale and calibration determine quantization error'})
