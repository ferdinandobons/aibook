...
- API: funzioni Python standard del modulo snip_57_contract
- comando snippet: python snip_57_contract.py
- comando test: python -m unittest -v test_57_contract.py
- snippet: eseguito
- test: 4 superati
