...
from snip_57_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'denoised': [0.78, 0.21999999999999997], 'steps': 1, 'invariant': 'a generation step declares its noise level and update'})
