# Audit del testo. Capitolo 29

- versione: 0.5.0-draft3
- data: 4 agosto 2026
- parole fuori dai blocchi di codice: 1001
- nuclei semantici: 5 (La mappa completa; Encoder; Decoder; Multi-head attention; Residual stream e output)
