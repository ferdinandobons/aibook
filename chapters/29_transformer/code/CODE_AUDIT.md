...
- API: funzioni Python standard del modulo snip_29_contract
- comando snippet: python snip_29_contract.py
- comando test: python -m unittest -v test_29_contract.py
- snippet: eseguito
- test: 4 superati
