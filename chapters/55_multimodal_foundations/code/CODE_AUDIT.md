...
- API: funzioni Python standard del modulo snip_55_contract
- comando snippet: python snip_55_contract.py
- comando test: python -m unittest -v test_55_contract.py
- snippet: eseguito
- test: 4 superati
