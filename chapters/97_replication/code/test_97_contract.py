...
from snip_97_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'difference': -0.020000000000000018, 'same_split': True, 'invariant': 'a replication records setup differences before interpreting outcome differences'})
