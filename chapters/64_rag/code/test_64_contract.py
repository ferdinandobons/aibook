...
from snip_64_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'answer': 'Il pacco è in transito', 'citation': 'd1', 'invariant': 'RAG keeps retrieved evidence and generated answer as separate records'})
