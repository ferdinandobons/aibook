...
- API: funzioni Python standard del modulo snip_19_contract
- comando snippet: python snip_19_contract.py
- comando test: python -m unittest -v test_19_contract.py
- snippet: eseguito
- test: 4 superati
