...
- API: funzioni Python standard del modulo snip_79_contract
- comando snippet: python snip_79_contract.py
- comando test: python -m unittest -v test_79_contract.py
- snippet: eseguito
- test: 4 superati
