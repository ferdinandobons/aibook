...
from snip_50_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'accepted': ['4', '4'], 'acceptance_rate': 0.6666666666666666, 'invariant': 'a verifier is an explicit signal with its own error surface'})
