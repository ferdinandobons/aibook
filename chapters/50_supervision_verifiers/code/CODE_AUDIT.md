...
- API: funzioni Python standard del modulo snip_50_contract
- comando snippet: python snip_50_contract.py
- comando test: python -m unittest -v test_50_contract.py
- snippet: eseguito
- test: 4 superati
