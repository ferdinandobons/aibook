...
from snip_77_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'accepted': ['a', 'b'], 'fallback': 'target_next', 'invariant': 'speculative decoding verifies draft tokens before committing them'})
