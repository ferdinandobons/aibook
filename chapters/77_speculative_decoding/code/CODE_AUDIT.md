...
- API: funzioni Python standard del modulo snip_77_contract
- comando snippet: python snip_77_contract.py
- comando test: python -m unittest -v test_77_contract.py
- snippet: eseguito
- test: 4 superati
