...
- API: funzioni Python standard del modulo snip_62_contract
- comando snippet: python snip_62_contract.py
- comando test: python -m unittest -v test_62_contract.py
- snippet: eseguito
- test: 4 superati
