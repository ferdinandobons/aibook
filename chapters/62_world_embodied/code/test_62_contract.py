...
from snip_62_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'action': 'move', 'next_state': {'position': 1, 'battery': 1}, 'invariant': 'the world transition exposes state and action consequences'})
