...
- API: funzioni Python standard del modulo snip_75_contract
- comando snippet: python snip_75_contract.py
- comando test: python -m unittest -v test_75_contract.py
- snippet: eseguito
- test: 4 superati
