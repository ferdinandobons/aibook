...
from snip_75_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'restored': [-0.5, 0.0, 0.5], 'accumulated': 0.0, 'invariant': 'nominal bit width is distinct from accumulation precision'})
