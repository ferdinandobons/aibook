...
- API: funzioni Python standard del modulo snip_85_contract
- comando snippet: python snip_85_contract.py
- comando test: python -m unittest -v test_85_contract.py
- snippet: eseguito
- test: 4 superati
