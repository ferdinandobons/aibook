...
from snip_85_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'component_failures': ['citation'], 'system_success': False, 'invariant': 'end-to-end evaluation keeps component failures visible'})
