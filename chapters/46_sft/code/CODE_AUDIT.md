...
- API: funzioni Python standard del modulo snip_46_contract
- comando snippet: python snip_46_contract.py
- comando test: python -m unittest -v test_46_contract.py
- snippet: eseguito
- test: 4 superati
