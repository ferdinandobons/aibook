...
from snip_46_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'supervised_tokens': ['assistente', 'risposta'], 'label_count': 2, 'invariant': 'loss masking distinguishes prompt tokens from target tokens'})
