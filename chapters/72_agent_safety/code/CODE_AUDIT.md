...
- API: funzioni Python standard del modulo snip_72_contract
- comando snippet: python snip_72_contract.py
- comando test: python -m unittest -v test_72_contract.py
- snippet: eseguito
- test: 4 superati
