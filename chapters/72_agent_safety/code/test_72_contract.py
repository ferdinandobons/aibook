...
from snip_72_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'allowed': False, 'approval_required': True, 'invariant': 'authorization and rollback live outside the model text'})
