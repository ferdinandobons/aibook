...
- API: funzioni Python standard del modulo snip_38_contract
- comando snippet: python snip_38_contract.py
- comando test: python -m unittest -v test_38_contract.py
- snippet: eseguito
- test: 4 superati
