...
from snip_38_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'position': 2, 'rotated': [0.540302, 0.841471], 'invariant': 'the positional transform is indexed by position'})
