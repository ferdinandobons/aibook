...
- API: funzioni Python standard del modulo snip_48_contract
- comando snippet: python snip_48_contract.py
- comando test: python -m unittest -v test_48_contract.py
- snippet: eseguito
- test: 4 superati
