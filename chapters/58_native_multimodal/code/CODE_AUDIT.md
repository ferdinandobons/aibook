...
- API: funzioni Python standard del modulo snip_58_contract
- comando snippet: python snip_58_contract.py
- comando test: python -m unittest -v test_58_contract.py
- snippet: eseguito
- test: 4 superati
