...
- API: funzioni Python standard del modulo snip_22_contract
- comando snippet: python snip_22_contract.py
- comando test: python -m unittest -v test_22_contract.py
- snippet: eseguito
- test: 4 superati
