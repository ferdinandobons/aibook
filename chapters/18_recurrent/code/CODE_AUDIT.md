...
- API: funzioni Python standard del modulo snip_18_contract
- comando snippet: python snip_18_contract.py
- comando test: python -m unittest -v test_18_contract.py
- snippet: eseguito
- test: 4 superati
