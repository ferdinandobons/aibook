...
- Titolo o riferimento: Hochreiter e Schmidhuber, Long Short-Term Memory.
...
- Affermazioni sostenibili: Una RNN aggiorna uno stato nascosto con input e stato precedente. La recurrence mantiene memoria compatta; l'attention accede a rappresentazioni esplicite.
...
- Titolo o riferimento: Cho et al., Learning Phrase Representations using RNN Encoder-Decoder.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Il grafo ricorrente viene srotolato nel tempo.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.

## SRC-18-003

- Titolo o riferimento: Sutskever, Vinyals e Le, Sequence to Sequence Learning with Neural Networks.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Gate di input, forget e output controllano il flusso della memoria.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.

## SRC-18-004

- Titolo o riferimento: Pascanu, Mikolov e Bengio, On the difficulty of training recurrent neural networks.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Una rete bidirezionale usa anche il futuro ed è adatta a encoding offline.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
