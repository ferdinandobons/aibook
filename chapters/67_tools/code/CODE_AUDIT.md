...
- API: funzioni Python standard del modulo snip_67_contract
- comando snippet: python snip_67_contract.py
- comando test: python -m unittest -v test_67_contract.py
- snippet: eseguito
- test: 4 superati
