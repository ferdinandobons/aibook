...
from snip_67_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'allowed': True, 'request': {'tool': 'lookup_order', 'order_id': 'A1'}, 'invariant': 'tool execution requires validation outside generated text'})
