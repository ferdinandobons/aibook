...
from snip_65_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'path': ['q1', 'd1', 'q2', 'd2'], 'invariant': 'multi-hop retrieval records the path rather than only the final context'})
