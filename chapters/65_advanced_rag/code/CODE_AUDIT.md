...
- API: funzioni Python standard del modulo snip_65_contract
- comando snippet: python snip_65_contract.py
- comando test: python -m unittest -v test_65_contract.py
- snippet: eseguito
- test: 4 superati
