# Audit del testo. Capitolo 65

- versione: 0.5.0-draft3
- data: 4 agosto 2026
- parole fuori dai blocchi di codice: 1062
- nuclei semantici: 5 (Query transformation; Retrieval adattivo; Corrective RAG; Graph RAG; RAG agentico)
