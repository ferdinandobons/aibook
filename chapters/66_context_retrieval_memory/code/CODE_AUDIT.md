...
- API: funzioni Python standard del modulo snip_66_contract
- comando snippet: python snip_66_contract.py
- comando test: python -m unittest -v test_66_contract.py
- snippet: eseguito
- test: 4 superati
