...
from snip_52_contract import contract
...
class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'trace_count': 3, 'selected': '4', 'invariant': 'self-consistency selects among traces and does not prove their faithfulness'})
