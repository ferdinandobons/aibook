...
- API: funzioni Python standard del modulo snip_52_contract
- comando snippet: python snip_52_contract.py
- comando test: python -m unittest -v test_52_contract.py
- snippet: eseguito
- test: 4 superati
