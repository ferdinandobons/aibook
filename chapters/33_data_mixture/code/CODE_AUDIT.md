...
- API: funzioni Python standard del modulo snip_33_contract
- comando snippet: python snip_33_contract.py
- comando test: python -m unittest -v test_33_contract.py
- snippet: eseguito
- test: 4 superati
