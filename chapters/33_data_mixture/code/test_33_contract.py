...
from snip_33_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'probabilities': [0.472734, 0.334273, 0.192993], 'invariant': 'the mixture is normalized after temperature sampling'})
