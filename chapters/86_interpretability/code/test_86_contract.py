...
from snip_86_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'baseline': 0.6, 'intervened': 0.25, 'effect': -0.35, 'invariant': 'an intervention is compared with a baseline before causal language'})
