...
- API: funzioni Python standard del modulo snip_86_contract
- comando snippet: python snip_86_contract.py
- comando test: python -m unittest -v test_86_contract.py
- snippet: eseguito
- test: 4 superati
