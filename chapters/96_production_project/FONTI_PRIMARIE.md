# Fonti primarie e autorevoli. Capitolo 96

- Data di consultazione: 4 agosto 2026
- Routing semantico: capitolo 96 -> tema `production`.
...
- Titolo o riferimento: Sculley et al., Hidden Technical Debt in Machine Learning Systems.
- Autori o organizzazione: Sculley et al..
...
- URL o identificatore: https://papers.nips.cc/paper/5656-hidden-technical-debt-in-machine-learning-systems
- Data di consultazione: 4 agosto 2026.
...
- Sezioni rilevanti: Abstract / pagina iniziale; Hidden Technical Debt in Machine Learning Systems.
...
- Affermazioni sostenibili: Use case, utenti, output, autorizzazioni e costi degli errori precedono la scelta del modello. Model card, data card, runbook e decision log rendono il progetto revisionabile e aggiornabile.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Dataset offline, test end-to-end, canary e monitoraggio coprono livelli differenti.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Versioni, secret, rollback, observability e incident response vengono esercitati prima del traffico reale.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.

## SRC-96-004

- Titolo o riferimento: Google, Rules of Machine Learning.
- Autori o organizzazione: Google.
- Tipo: paper o report tecnico.
- Data: data della revisione consultata.
- Versione, revisione o commit: revisione o versione disponibile all'URL consultato il 4 agosto 2026.
- URL o identificatore: https://developers.google.com/machine-learning/guides/rules-of-ml
- Data di consultazione: 4 agosto 2026.
- Verifica d'accesso: opened-context; pagina originale aperta; titolo, testo e intestazioni estratti; nessun risultato numerico trasferito.
- Sezioni rilevanti: Abstract / pagina iniziale; Monitoring.
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Modello, retrieval, tool, storage e policy sono separati da interfacce e schemi.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
