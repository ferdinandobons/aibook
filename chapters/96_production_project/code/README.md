...
`snip_96_contract.py` esegue il caso minimo usato nel testo di **Progetto di produzione completo**. `test_96_contract.py` conserva l'output atteso, controlla determinismo, serializzazione, valori finiti, forma del contratto e rifiuto dei casi non documentati.
