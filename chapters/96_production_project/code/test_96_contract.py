...
from snip_96_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'version': 'v2', 'ready_for_review': True, 'invariant': 'production readiness requires independent gates and a rollback path'})
