...
from snip_54_contract import contract


class LessonExampleTests(unittest.TestCase):
    def test_expected_result(self):
        self.assertEqual(contract(), {'changed_keys': ['ritardo'], 'rollback': True, 'invariant': 'an edit needs a targeted diff and a regression check'})
