...
- API: funzioni Python standard del modulo snip_54_contract
- comando snippet: python snip_54_contract.py
- comando test: python -m unittest -v test_54_contract.py
- snippet: eseguito
- test: 4 superati
