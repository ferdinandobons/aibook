...
- API: funzioni Python standard del modulo snip_41_contract
- comando snippet: python snip_41_contract.py
- comando test: python -m unittest -v test_41_contract.py
- snippet: eseguito
- test: 4 superati
