...
- API: funzioni Python standard del modulo snip_21_contract
- comando snippet: python snip_21_contract.py
- comando test: python -m unittest -v test_21_contract.py
- snippet: eseguito
- test: 4 superati
