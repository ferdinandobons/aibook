# Fonti primarie e autorevoli. Capitolo 21

- Data di consultazione: 3 agosto 2026
- Routing semantico: capitolo 21 -> tema `autoregressive`.
...
- Titolo o riferimento: Graves, Generating Sequences With Recurrent Neural Networks.
- Autori o organizzazione: Graves.
...
- URL o identificatore: https://arxiv.org/abs/1308.0850
- Data di consultazione: 3 agosto 2026.
...
- Sezioni rilevanti: Abstract / pagina iniziale; Generating Sequences With Recurrent Neural Networks; 2 Prediction Network; 3 Text Prediction.
...
- Affermazioni sostenibili: La chain rule scompone la probabilità con un ordine. L'autoregressione non è limitata al testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Durante il training il modello riceve il prefisso reale e predice il passo successivo.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: La causal mask impedisce a una posizione di usare target futuri.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
...
- Perimetro del supporto: la fonte è usata per la definizione o il meccanismo indicato; esempi, derivazioni e risultati locali restano separati.
- Affermazioni sostenibili: Ogni scelta modifica il contesto successivo.
- Limiti: non autorizza generalizzazioni a ogni modello, dataset, implementazione o prodotto.
- Divergenze note: eventuali differenze di obiettivo, dataset o implementazione vanno mantenute separate nel testo.
