...
- GitHub, repository, pull request, branch o commit;
- stato del progetto o indice del libro;
- browser, finestre software o mockup di pagina;
- numeri di capitoli non pertinenti;
- dichiarazioni sul completamento del libro;
