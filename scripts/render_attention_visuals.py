...
OUT1 = ROOT / 'assets/chapters/28_attention/ATT-01/candidate-v4.png'
...
C={'bg':'#FFFFFF','white':'#FFFFFF','ink':'#162033','muted':'#4C5A70','line':'#C7D2E0','strong':'#8797AA','blue':'#2864D7','bsoft':'#EEF5FF','green':'#238B57','gsoft':'#EDF9F1','amber':'#B77A16','asoft':'#FFF8E7','red':'#B52A35','rsoft':'#FFF1F2','purple':'#7653B5','psoft':'#F5F0FF','gray':'#F1F4F8'}
...
def save(im,path):
    ...
    if im.size != (1800,1000):
        im = im.resize((1800,1000), Image.Resampling.LANCZOS)
...
def att01():
    ...
    vals=[]
    for x,t in zip((110,255,400),('v1','v2','v3')): r=(x,290,x+115,355); pill(d,r,t,C['bsoft'],C['blue'],28,True,True); vals.append(r)
    ...
    pill(d,(135,500,370,590),'c per q1\nidentico',C['rsoft'],C['red'],25); pill(d,(455,500,690,590),'c per q2\nidentico',C['rsoft'],C['red'],25)
    ...
    x0=865; widths=[100,110,110,110,125]; heads=['query','v1','v2','v3','output']; x=x0
    ...
    for row,(q,ws,o) in enumerate((('q1',('0,10','0,60','0,30'),'c1'),('q2',('0,05','0,15','0,80'),'c2'))):
    ...
    rr(d,(865,610,1510,700),C['gsoft'],C['green'],2,16); center(d,(865,610,1510,700),'Risultato: q1 e q2 producono combinazioni\ndiverse.',25,True,color=C['green'])
...
def att02():
    ...
    pill(d,(45,34,165,86),'ATT-02',C['blue'],C['blue'],26,True,False,'white'); left(d,(195,60),'Una query, tre key, tre value',42,True); left(d,(195,104),'Esempio numerico illustrativo con d_k = d_v = 2',25,False,C['muted'])
